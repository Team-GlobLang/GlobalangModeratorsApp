<template>
    <div v-if="fullName"
        class="w-full rounded-2xl p-4 py-6 flex items-center gap-4 bg-white shadow transition-all md:max-w-md md:mx-auto xl:max-w-lg">
        ...
        <div class="flex flex-col">
            <span class="text-xl not-first:font-bold text-blue-700 mb-1">Welcome back, {{ fullName }}!</span>
            <span class="text-lg">System moderator</span>
            <span class="text-md">
